package com.jiuhong.dds.core.voip;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Consts.ACTION_VOIP_RECEIVER.equals(action)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                if (com.jiuhong.dds.core.util.Utils.isAppRunningForeground()) {
                ...
                onForegroundOrBeforeVersionO(
                        ...
                        audioOnly,
                        inviteUserName,
                        com.jiuhong.dds.core.util.Utils.isAppRunningForeground()
                );
            }
        }
    }
