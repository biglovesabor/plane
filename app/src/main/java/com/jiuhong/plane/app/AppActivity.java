...
import com.jiuhong.plane.action.TitleBarAction;
import com.jiuhong.plane.action.ToastAction;
...
//        overridePendingTransition(R.anim.left_in_activity, R.anim.left_out_activity);
    ...
    public LoginBean1 userBean(){
        if (SPUtils.contains("userbean")){
            userbean = new Gson().fromJson(SPUtils.getString("userbean", ""), LoginBean1.class);
            return userbean;
        }else {
            return new LoginBean1();
        }
    }
}