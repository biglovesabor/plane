 ...
 *    desc   : 数据采集   页面1
 */
public final class HomeGrid2Activity extends AppActivity {
    ...
    protected int getLayoutId() {
        return R.layout.home_grid2_activity;
    }
    ...
    protected void initView() {
        ...
        setOnClickListener(ll_view1, ll_view2,ll_view3,ll_view4,ll_view5, tv_item1, tv_item2);
    ...
    public void onClick(View view) {
        ...
        if (view==tv_item2){
            Intent intent = new Intent(getContext(),HomeGrid2Caiji3Activity.class);
            startActivity(intent);
            overridePendingTransition(0,0);
        }
    }
